...
@section('content')
    @php($headline = 'Appointment Confirmed')
    <div style="font-size:16px;line-height:1.7;color:#241b1e;">
        <p style="margin:0 0 14px;">Hi {{ $appointment->name }}, your appointment has been confirmed by Kharbanda Makeup Studio.</p>
        <div style="margin:22px 0;padding:18px 20px;background:#fff7f8;border:1px solid rgba(232,75,121,.14);border-radius:18px;">
            <div style="font-size:13px;letter-spacing:.12em;text-transform:uppercase;color:#e84b79;font-weight:700;margin-bottom:8px;">Appointment Details</div>
